        ...
        <div className="min-h-screen font-sans relative flex flex-col bg-black">
            ...
            <header className="p-6 flex justify-between items-center bg-transparent relative z-20">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a href="https://discord.gg/vQqwqeXg" target="_blank" rel="noopener noreferrer" className="bg-[#5865F2] hover:bg-[#4752C4] text-white px-6 py-2 rounded-full font-bold transition-all text-sm flex items-center justify-center">
                        Join Discord
                    </a>
                </div>
            </header>
